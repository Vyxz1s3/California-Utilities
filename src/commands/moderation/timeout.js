...
export default {
  ...
  async execute(interaction, client) {
    ...
    if (!interaction.member.permissions.has(PermissionFlagsBits.ModerateMembers)) {
      return interaction.reply({ content: '❌ You do not have permission to timeout users.', ephemeral: true });
    }
    ...
    await query(
      ...
      [interaction.guild.id, user.id, interaction.user.id, 'timeout', reason]
    );
